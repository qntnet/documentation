...
Quantnet использует бэктестер, основанный на экспозиции. Алгоритм торговли должен определять доли капитала, которые будут распределены по активам (веса распределения).
...
Вот как будет выглядеть массив весов. Обратите внимание, что для каждого дня у нас есть вес для каждого актива, соответствующий тому, сколько капитала будет распределено по этому активу в длинной (**положительный** вес) или
...
Результаты алгоритма, рассчитанные на исторических данных, обычно представлены на [графике прибыли (equity)](/intro/rr.md), чтобы понять поведение совокупной прибыли:
...
Ваши стратегии должны инвестировать менее 5% капитала (инвестируемого) в какой-либо один актив.
[Подробнее](/reference/evaluation.md)
...
В личном кабинете пользователя доступны примеры других стратегии,  [зарегистрируйтесь на платформе](https://quantnet.ai/personalpage/registration).
